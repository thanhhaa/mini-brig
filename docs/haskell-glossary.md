# Haskell / Servant — Thuật ngữ ngôn ngữ
...
- [[ghci-repl-commands]] — thực hành `:kind!`, `fromJSON`, `toJSON` trong repl
- [[test-suite-setup]] — deriving strategy, JSON serialization trong test thực tế
- [[serve-capture-fromhttpapidata]] — `FromHttpApiData`, `Capture` trong Servant
